# SupeMQ Clients and Channels Provisioning Tool
...
that can be used by SupeMQ MQTT benchmarking tool (`mqtt-bench`).
...
```
./provision --help
Tool for provisioning series of SupeMQ channels and clients and connecting them together.
